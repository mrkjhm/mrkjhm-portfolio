...
export default function Landing() {
    ...
    const clickToResume = () => {
      window.open(
        "https://drive.google.com/file/d/1d5OY0LFgQK_4tb0s4FzICnWLjWuveVIy/view?usp=sharing",
        "_blank"
      );
    };
    ...
    return (
      <div className={styles.landing}>
        <Image src={avatar} alt="avatar" fill={true} priority />
        <div className={styles.left}>
          ...
          <div className={styles.description}>
            <p>
              I’m a Multimedia Designer and <br />
